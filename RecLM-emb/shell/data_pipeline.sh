...
python preprocess/data_process.py --in_seq_data $in_seq_data --in_meta_data $in_meta_data --out_user2item $out_user2item --out_unorder_user2item $out_unorder_user2item \
...
python preprocess/resample_by_item_freq.py --in_seq_data $in_seq_data --in_meta_data $in_meta_data \
    --candidate_files $out_misspell2item,$out_negquery2item,$out_query2item,$out_title2item,$out_vaguequery2item,$out_gpt,$out_gpt_v2 \
