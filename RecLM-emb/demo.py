...
if __name__ == '__main__':
    ...
    def user_infer(text, model_choice, topk):
        ...
        if model_choice == "intfloat/e5-large-v2":
            ...
            if accelerator.is_main_process:
                base_model_output = gen_retrieval_result(item_embedding_prompt_path, topk, e5_model_item_embedding_path, user_embedding_path)
            accelerator.wait_for_everyone()
        ...
        if accelerator.is_main_process:
            our_model_output = gen_retrieval_result(item_embedding_prompt_path, topk, our_model_item_embedding_path, user_embedding_path)
        accelerator.wait_for_everyone()
